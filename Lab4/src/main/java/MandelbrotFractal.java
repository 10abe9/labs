...
public class MandelbrotFractal extends FractalGenerator {
    ...
    public String toString(){return "MandelbrotFractal";}
    ...
    static class ComplexNumber {
        ...
        {
            if (this.realPart>=0){return new ComplexNumber(this.getRealPart(), this.getImaginPart());}
            else return new ComplexNumber(this.getRealPart(), Math.abs(this.getImaginPart()));
        }
    }
}
